...
import 'package:flutter_advanced_topics/src/presentation/widgets/custom_widget/custom_tap_bar_widget.dart';
      ...
      child: ScreenUtilInit(
        ...
        child: MaterialApp(
          ...
          home: const CustomTabBarWidget(
              titleOfTapOne: "titleOfTapOne",
              titleOfTapTwo: "titleOfTapTwo",
              contentOfTapOne: Center(
                  child: Text(
                "contentOfTapOne",
              )),
              contentOfTapTwo: Center(
                  child: Text(
                "contentOfTapTwo",
              ))),
        ),
